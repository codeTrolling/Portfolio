...
const About = forwardRef((props, viewportRef) => {
    ...
    return(
        <div className="viewport flex-column" ref={viewportRef} style={{opacity: isOnScreen ? "1" : "0", transition: isOnScreen ? "all 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94)" : "all 1s linear", transform: isOnScreen ? "translateX(0)" : "translate(100px)"}}>
            ...
            <p className="theme-font-family">Hello! I am a student in computer science as well as an aspiring programmer who has been studying programming science high school. <br/> I like playing video games and sports and watching useless youtube videos.
            <br/> In this portfolio website, I will talk about my journey so far, the skills I have acquired, the way I learn and a lot more including some tips on how to improve yourself if you are a beginner. I hope you will like going through everything.
